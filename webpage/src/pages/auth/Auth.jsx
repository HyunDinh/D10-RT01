...
const Auth = () => {
    ...
    useEffect(() => {
        ...
        fetch('https://hocho-c7ekfwhrehavd6fr.southeastasia-01.azurewebsites.net/api/auth/user', {
            method: 'GET',
            credentials: 'include',
            headers: {
    ...
    const handleGoogleLogin = () => {
        window.location.href = 'https://hocho-c7ekfwhrehavd6fr.southeastasia-01.azurewebsites.net/oauth2/authorization/google';
    };
