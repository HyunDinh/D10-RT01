        ...
        <footer className="footer">
            ...
            <div className="container">
                <div className="footer-contact-info">
                    <div className="contact-info-items" data-aos="fade-up" data-aos-duration="800" data-aos-delay="300">
                        <div className="icon">
                    ...
                    <div className="contact-info-items" data-aos="fade-up" data-aos-duration="800" data-aos-delay="500">
                        <div className="icon">
                            <svg width="30" height="30" viewBox="0 0 30 30" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <div className="contact-info-items" data-aos="fade-up" data-aos-duration="800" data-aos-delay="700">
                        <div className="icon">
            ...
            <div className="container">
                <div className="footer-grid">
                    <div className="footer-widget" data-aos="fade-up" data-aos-duration="800" data-aos-delay="300">
                    ...
                    <div className="footer-widget" data-aos="fade-up" data-aos-duration="800" data-aos-delay="500">
                        <div className="widget-header">
                            <h3>Quick Links</h3>
                        </div>
                    ...
                    <div className="footer-widget" data-aos="fade-up" data-aos-duration="800" data-aos-delay="500">
                        ...
                        <ul className="link-list">
                            <li><a href="/program-details"><i className="fas fa-chevron-right"></i> Music
                                Learning</a></li>
                            <li><a href="/program-details"><i className="fas fa-chevron-right"></i> Sports,
                                Games</a></li>
                            <li><a href="/program-details"><i className="fas fa-chevron-right"></i> Science
                                Class</a></li>
                            <li><a href="/program-details"><i className="fas fa-chevron-right"></i> Drawing</a></li>
                        </ul>
                    </div>
                    <div className="footer-widget" data-aos="fade-up" data-aos-duration="800" data-aos-delay="700">
                        <div className="widget-header">
                            <h3>Recent Posts</h3>
                        </div>
                        <div className="recent-posts">
                            <article className="post">
                                ...
                                <div className="post-content">
                                    <span className="post-date"><i
                                        className="fas fa-calendar-days"></i> 20 Feb, 2024</span>
                            ...
                            <article className="post">
                                ...
                                <div className="post-content">
                                    <span className="post-date"><i
                                        className="fas fa-calendar-days"></i> 15 Dec, 2024</span>
                ...
                <div className="bottomFooter">
                    <img src="/footerBottom.png" alt="Logo" loading="lazy"/>
                </div>
            </div>
