  ...
  return (
    <div className={styles.quizListContainer}>
      <div className={styles.quizListHeader}>
        ...
        <Link to={`/quizzes/create?courseId=${courseId}`} className={styles.quizListCreateBtn}>
          Tạo Quiz mới
        </Link>
      </div>
          ...
          {quizzes.map(quiz => (
            <div key={quiz.quizId} className={styles.quizCard}>
              ...
              <div className={styles.quizCardFooter}>
                <Link to={`/quizzes/${quiz.quizId}`} className={styles.quizCardBtn}>
                  Chi tiết
                </Link>
                <Link to={`/quizzes/${quiz.quizId}/edit`} className={styles.quizCardBtn}>
                  Chỉnh sửa
                </Link>
              </div>
            </div>
