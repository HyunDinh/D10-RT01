package com.d10rt01.hocho.controller.quiz;
...
import com.d10rt01.hocho.service.quiz.QuizService;
...
import com.d10rt01.hocho.dto.QuizSubmissionDto;
...
public class QuizController {
    ...
    private String saveQuizImage(MultipartFile file) {
        try {
            String uploadDir = Configs.ABSOLUTE_PATH_QUIZ_UPLOAD_DIR;
    ...
    private byte[] processImageFile(MultipartFile file) throws IOException {
        ...
        if (fileSize <= Configs.MAX_QUIZ_IMAGE_SIZE) {
            return fileBytes;
        }
        ...
        while (fileSize > Configs.MAX_QUIZ_IMAGE_SIZE && quality > 0.1 && scale > 0.1) {
            outputStream.reset();
