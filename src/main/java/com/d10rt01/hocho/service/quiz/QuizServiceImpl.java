...
import com.d10rt01.hocho.repository.quiz.QuizRepository;
import com.d10rt01.hocho.repository.quiz.QuizQuestionRepository;
import com.d10rt01.hocho.repository.quiz.QuizResultRepository;
import com.d10rt01.hocho.repository.quiz.QuizAnswerRepository;
import com.d10rt01.hocho.repository.quiz.QuizOptionRepository;
...
public class QuizServiceImpl implements QuizService {
    ...
    @Override
    @Transactional
    public com.d10rt01.hocho.model.QuizResult submitQuiz(Long quizId, Long childId, List<com.d10rt01.hocho.dto.QuizAnswerDto> answers) {
        com.d10rt01.hocho.model.Quiz quiz = getQuiz(quizId);
        com.d10rt01.hocho.model.User child = userRepository.findById(childId)
                .orElseThrow(() -> new RuntimeException("Không tìm thấy học sinh"));

        com.d10rt01.hocho.model.QuizResult existingResult = quizResultRepository.findByQuizAndChild(quiz, child);
        
        com.d10rt01.hocho.model.QuizResult quizResult;
        if (existingResult != null) {
            ...
            quizResult = new com.d10rt01.hocho.model.QuizResult();
        ...
        int totalScore = 0;
        List<com.d10rt01.hocho.model.QuizAnswer> quizAnswers = new ArrayList<>();

        for (com.d10rt01.hocho.dto.QuizAnswerDto answerDto : answers) {
            Long questionId = answerDto.getQuestionId();
            String selectedOptionKey = answerDto.getSelectedOptionId();

            com.d10rt01.hocho.model.QuizQuestion question = quizQuestionRepository.findById(questionId)
            ...
            com.d10rt01.hocho.model.QuizAnswer quizAnswer = new com.d10rt01.hocho.model.QuizAnswer();
