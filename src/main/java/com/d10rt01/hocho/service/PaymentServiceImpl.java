...
public class PaymentServiceImpl implements PaymentService {
    ...
    @Override
    @Transactional
    public Payment createPayment(Long userId, List<Long> cartItemIds) {
        ...
        payment.setDescription("Thanh toán đơn hàng #" + order.getOrderId()); // Mô tả thanh toán
        ...
        try {
            ...
            PaymentData paymentData = PaymentData.builder()
                    ...
                    .returnUrl(baseUrl + "/payment/success") // Cần endpoint frontend xử lý callback
                    .cancelUrl(baseUrl + "/payment/cancel")   // Cần endpoint frontend xử lý callback
                    .items(payosItems) // Sử dụng danh sách items chi tiết
                    .build();
        ...
        switch (status.toUpperCase()) {
            case "PAID":
                ...
                if (payment.getOrder() != null) {
                     ...
                     // Cần lấy payosTransactionId từ dữ liệu webhook. Tạm thời dùng orderCode của payment.
                     // Cần kiểm tra cấu trúc dữ liệu webhook của PayOS để lấy thông tin chính xác.
                     transaction.setPayosTransactionId(String.valueOf(payment.getOrderCode()));
                     transaction.setAmount(completedOrder.getTotalAmount()); // Sử dụng tổng tiền từ Order
                     ...
                     if (completedOrder.getOrderItems() != null) {
                         for (OrderItem item : completedOrder.getOrderItems()) {
                             ...
                             enrollment.setParent(completedOrder.getParent()); // Phụ huynh từ Order
