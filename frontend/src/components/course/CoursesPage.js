  ...
  return (
      <div className="container mt-5">
          <div className="d-flex justify-content-between align-items-center mb-4">
            <h1>Course List</h1>
            <div>
              <Link to={`/hocho/teachers/${userId}/courses/add`} className="btn btn-success me-2">
                Add New Course
              </Link>
              <Link to="/hocho" className="btn btn-secondary">
                Back to Teachers
              </Link>
            </div>
          </div>
          ...
          <table className="table table-striped">
            ...
            {filteredCourses.map(course => (
                <tr key={course.courseId}>
                  ...
                  <td>
                    <Link to={`/hocho/teachers/${userId}/courses/${course.courseId}/`} className="btn btn-dark btn-sm me-2">
                      View Lessons
                    </Link>
                    <Link to={`/hocho/teachers/${userId}/courses/${course.courseId}/edit`} className="btn btn-warning btn-sm me-2">
                      Edit
                    </Link>
                    <button
